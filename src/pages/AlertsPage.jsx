...
export default function AlertsPage() {
    ...
    const removeRecipient = async (id) => {
        try { await alertApi.deleteRecipient(id); recipients.reload(); notice.success(t('recipientDeleted')) }
        catch (error) { notice.fail(error.message) }
    }
