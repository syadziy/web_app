...
export default function AlertsPage() {
    ...
    const recipients = useRemoteList((signal) => alertApi.recipients({ limit: 100, offset: 0 }, signal), 'alert-recipients', canReadRecipients)
    const [historyResult, setHistoryResult] = useState('')
    const deliveryHistory = useRemoteList((signal) => alertApi.deliveryHistory({ ...(historyResult ? { result: historyResult } : {}), limit: 100, offset: 0 }, signal), historyResult, canReadHistory)
